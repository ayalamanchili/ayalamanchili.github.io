...
<p>I am going to share some lessons and best practices that are a result of years of work across projects, teams and cultures pertaining to software delivery and security.</p>
<h3 id="before-state">Before State</h3>
<p>Security is a after thought and necessary evil that software delivery teams have to deal that typically involved.</p>
<ul>
<li>production release needs a security review</li>
<li>a manual process to review (via SAST tools) the software code identifying the vulnerabilities in code that was build in a ~6 month time frame.</li>
<li>creating security bugs or tasks for high risk issues that need to be fixed before release ( typically 2 weeks)</li>
...
<li>with growing pressure from business with release will end up creating risk tickets being accepted.</li>
</ul>
<h3 id="current-state">Current State</h3>
<p>Security is integrated into the development life cycle from project initialization and any issues are identified and fixed at the first step they arise from.  This helps to made teams deliver secure software faster.</p>
